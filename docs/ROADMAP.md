...
`v0.1.3` is the current globally installable release of the queue + worker
runtime.
...
deliberate limitation of `v0.1.3`, not a hidden incomplete implementation.
