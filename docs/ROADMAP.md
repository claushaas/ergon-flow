...
`v0.2.1` is the current globally installable release of the queue + worker
runtime.
...
deliberate limitation of `v0.2.1`, not a hidden incomplete implementation.
