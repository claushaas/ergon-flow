...
`v0.2.3` is the current globally installable release of the queue + worker
runtime.
...
deliberate limitation of `v0.2.3`, not a hidden incomplete implementation.
